...
namespace hhh
{
    public partial class Ac_detail_Page : ContentPage
    {
        String ekyc_statuss = "";
        public Ac_detail_Page()
        {
            InitializeComponent();
      ...
      async  void OnSelection(object sender, SelectedItemChangedEventArgs e)
        ...
        public async void fetch_list()
        {
            ...
            String url = "http://dfsapi1.hp.gov.in:8082/test_rc_data_api/rest/rc_details/?Username=UnUzSUxnVXJqZTJsK3R6L2NBMWVNZz09&Password=V2QwK3lDMDJ4dUkwc0QrL1JNeVpjZz09&" + "Enter_rc_or_aadhar=" + rc_number;
