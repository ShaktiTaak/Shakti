...
namespace hhh
{
    ...
    public class PidDataProcessor1
    {
        ...
        string hmacValue)
        {
            ...
            {
                Console.WriteLine("Error generating Auth XML: " + ex.Message);
            }
        ...
        public async Task<string> getKycRequest(string authXml)
        {
            ...
            {
                Console.WriteLine("Error while building KYC request: " + ex.Message);
                return string.Empty;
            }
        }
        ...
        public async Task<string> PostRequestKycAsync(string requestXml, string url, string authType)
        {
            ...
            {
                Console.WriteLine("Exception while posting KYC request: " + ex.Message);
                return null;
            }
            return null;
        }
